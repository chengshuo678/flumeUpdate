...
import org.apache.flume.source.avro.AvroFlumeEventNew;
import org.apache.flume.source.avro.AvroSourceProtocolNew;
import org.apache.flume.source.avro.StatusNew;
...
public class RpcTestUtils {
   ...
   */
  public static void handlerSimpleAppendTest(AvroSourceProtocolNew handler)
  ...
  public static void handlerBatchAppendTest(AvroSourceProtocolNew handler)
      throws FlumeException, EventDeliveryException {
   ...
   */
  public static Server startServer(AvroSourceProtocolNew handler, int port,
                                   boolean enableCompression) {
    Responder responder = new SpecificResponder(AvroSourceProtocolNew.class, handler);
    Server server;
  ...
  public static Server startServer(AvroSourceProtocolNew handler) {
  ...
  public static class LoadBalancedAvroHandler implements AvroSourceProtocolNew {
    ...
    @Override
    public StatusNew append(AvroFlumeEventNew event) throws AvroRemoteException {
      if (failed) {
        logger.debug("Event rejected");
        return StatusNew.FAILED;
      }
    ...
    @Override
    public StatusNew appendBatch(List<AvroFlumeEventNew> events) throws
        AvroRemoteException {
      if (failed) {
   ...
   */
  public static class OKAvroHandler implements AvroSourceProtocolNew {
   ...
   */
  public static class FailedAvroHandler implements AvroSourceProtocolNew {
    ...
    @Override
    public StatusNew appendBatch(List<AvroFlumeEventNew> events) throws AvroRemoteException {
   ...
   */
  public static class UnknownAvroHandler implements AvroSourceProtocolNew {

    @Override
    public StatusNew append(AvroFlumeEventNew event) throws AvroRemoteException {
      logger.info("Unknown: Received event from append(): {}",
                  new String(event.getBody().array(), Charset.forName("UTF8")));
      return StatusNew.UNKNOWN;
    }
   ...
   */
  public static class ThrowingAvroHandler implements AvroSourceProtocolNew {
