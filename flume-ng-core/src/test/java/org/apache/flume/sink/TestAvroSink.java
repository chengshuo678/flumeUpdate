...
import org.apache.flume.source.AvroSourceNew;
...
public class TestAvroSink {
  ...
  private Server createServer(AvroSourceProtocolNew protocol)
      throws IllegalAccessException, InstantiationException {

    Server server = new NettyServer(new SpecificResponder(
        AvroSourceProtocolNew.class, protocol), new InetSocketAddress(
        hostname, port));
  ...
  public void testSslWithCompression() throws InterruptedException,
    ...
    AvroSourceNew source;
    Channel sourceChannel;
    int selectedPort;

    source = new AvroSourceNew();
  ...
  private static class MockAvroServer implements AvroSourceProtocolNew {
    ...
    @Override
    public StatusNew appendBatch(List<AvroFlumeEventNew> events)
  ...
  private static class DelayMockAvroServer implements AvroSourceProtocolNew {
  ...
  private Server createSslServer(AvroSourceProtocolNew protocol)
      throws IllegalAccessException, InstantiationException {
    Server server = new NettyServer(new SpecificResponder(
        AvroSourceProtocolNew.class, protocol), new InetSocketAddress(hostname, port),
