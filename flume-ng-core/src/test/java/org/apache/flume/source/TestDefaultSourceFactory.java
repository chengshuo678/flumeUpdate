...
public class TestDefaultSourceFactory {
  ...
  public void testDuplicateCreate()  {
    ...
    Assert.assertTrue(avroSource1 instanceof AvroSourceNew);
    Assert.assertTrue(avroSource2 instanceof AvroSourceNew);
  ...
  public void testSourceCreation() throws Exception {
    ...
    verifySourceCreation("avro-src", "avro", AvroSourceNew.class);
