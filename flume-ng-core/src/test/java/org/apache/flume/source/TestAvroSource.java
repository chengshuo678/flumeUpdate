...
public class TestAvroSource {
  ...
  private void doRequest(boolean serverEnableCompression, boolean clientEnableCompression,
    ...
    if (clientEnableCompression) {
      ...
      client = SpecificRequestor.getClient(
          AvroSourceProtocolNew.class, nettyTransceiver);
    } else {
    ...
    StatusNew status = client.append(avroEvent);

    Assert.assertEquals(StatusNew.OK, status);
  ...
  public void testSslRequest() throws InterruptedException, IOException {
    ...
    AvroSourceProtocolNew client = SpecificRequestor.getClient(
        AvroSourceProtocolNew.class, new NettyTransceiver(new InetSocketAddress(
