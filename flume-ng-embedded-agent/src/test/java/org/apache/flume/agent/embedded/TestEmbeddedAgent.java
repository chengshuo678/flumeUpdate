...
public class TestEmbeddedAgent {
  ...
  public void setUp() throws Exception {
    ...
    Responder responder = new SpecificResponder(AvroSourceProtocolNew.class,
        eventCollector);
  ...
  static class EventCollector implements AvroSourceProtocolNew {
    private final Queue<AvroFlumeEventNew> eventQueue =
        new LinkedBlockingQueue<AvroFlumeEventNew>();

    public Event poll() {
      AvroFlumeEventNew avroEvent = eventQueue.poll();
      if (avroEvent != null) {
