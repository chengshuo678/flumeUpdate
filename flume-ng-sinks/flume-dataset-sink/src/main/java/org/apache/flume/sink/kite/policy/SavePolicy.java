...
public class SavePolicy implements FailurePolicy {
  ...
  private final View<AvroFlumeEventNew> dataset;
  private DatasetWriter<AvroFlumeEventNew> writer;
  ...
  private SavePolicy(Context context) {
    ...
    if (Datasets.exists(uri)) {
      dataset = Datasets.load(uri, AvroFlumeEventNew.class);
    } else {
      DatasetDescriptor descriptor = new DatasetDescriptor.Builder()
          .schema(AvroFlumeEventNew.class)
          .build();
      dataset = Datasets.create(uri, descriptor, AvroFlumeEventNew.class);
    }
